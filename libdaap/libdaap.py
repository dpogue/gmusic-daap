...
class DaapHttpRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_send_reply(self, rcode, reply, content_type=DEFAULT_CONTENT_TYPE,
        ...
        try:
            ...
            self.send_header('DMAP-Server', self.server_version)
    ...
    def do_stream_file(self, db_id, item_id, ext, chunk):
        ...
        file_obj, fsize, hint = self.server.backend.get_file(item_id,
                                                generation, ext,
                                                self.get_session(),
        ...
        return (rc, [(file_obj, fsize, hint, seekpos, seekend)], extra_headers)
